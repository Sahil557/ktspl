    ...
    <section className="relative h-[600px] w-full overflow-hidden">
      ...
      <div className="relative z-10 flex h-full flex-col justify-center px-6 md:px-12 lg:px-16">
        <div className="max-w-3xl">
          <h1 className="text-3xl font-bold text-[#e6b800] md:text-4xl lg:text-5xl">Khelo Tech & Strategy</h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              href="/get-started"
              className="rounded-full bg-[#e6b800] px-6 py-2.5 font-medium text-[#0a0a3c] transition-colors hover:bg-[#d4a900]"
            >
              Get Started
            </Link>
            ...
            <Link
              href="/video"
              className="flex items-center gap-2 rounded-full border border-white/30 bg-transparent px-6 py-2.5 font-medium text-white transition-colors hover:bg-white/10"
            >
